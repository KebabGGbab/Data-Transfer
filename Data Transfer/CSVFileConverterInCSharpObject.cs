...
namespace Data_Transfer
{
    ...
    public class CSVFileConverterInCSharpObject<T> where T : class, new()
    {

        static CSVFileConverterInCSharpObject()
        {
        ...
        public static ICollection<T> GetObjects(string filePath, Encoding encoding, string separator)
        {
            ...
            PropertyInfo[] properties = CSVFileConverterInCSharpObject<T>.ComparePropertiesAndColumns(nameColumns);
